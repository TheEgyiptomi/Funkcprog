...
(Ha 2025-26 1. félévet ír.)

Kötelező irodalom:
-- Miran Lipovača: Learn You a Haskell for Great Good! A Beginner’s Guide; 8. fejezet végéig
...
three :: Int -- Szintén egész számokat ábrázol, de ez a végtelenségig; gyakorlatilag a RAM a határ.
three = 1
---------------------------------------------------------------------------------------
